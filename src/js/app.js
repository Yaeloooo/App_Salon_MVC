...
function iniciarApp() {
  ...
  tabs(); //cambia la seccion cuando se precinaen los tabs
  botonesPaginador(); //agrega o quita los bototes del paginador
  paginaSiguiente();
  paginaAnterior();
...
function mostrarSeccion() {
  ...
  const seleccionAnterior = document.querySelector(".mostrar");
...
function seleccinarServicio(servicio) {
  ...
  //comprobnar si un servicio yta fue agregado o quitado
...
function mostrarResumen() {
  ...
  // headisg para servicios en resumen
